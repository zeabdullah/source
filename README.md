...
You can find [Source's ER Diagram on Eraser](https://app.eraser.io/workspace/8FQjCJxkMfRbnclguIwf?origin=share&elements=S5rvZyZoHdEj9nQ0_fGEnQ).

<a href="https://app.eraser.io/workspace/8FQjCJxkMfRbnclguIwf?origin=share&elements=S5rvZyZoHdEj9nQ0_fGEnQ" title="Source ERD"><img src='./readme/eraser/erd.svg' alt="Source ERD" /></a>
...
1. You provide the AI agent with a chat message (e.g. a question or request for improvements) while the AI also has access to the current design or content you're working on as context (like a Figma screen or email template).
2. The agent takes your message in combination with the design, and then analyzes them.
3. Based on the analysis, the AI decides what changes or suggestions would be most helpful to you.
4. The AI finally, explaining its suggestions. If you're working on an email template, it can also update the template directly, which will sync with your Brevo account.
...
<a href="https://app.eraser.io/workspace/SqWrjAjs3ZXSz63z6krC/preview?elements=InB5GaDXt07mXDVseltFeg&type=embed" title="Source ERD"><img src='./readme/eraser/bpmn.png' alt="Source BPMN" /></a>

[View on Eraser!](https://app.eraser.io/workspace/SqWrjAjs3ZXSz63z6krC/preview?elements=InB5GaDXt07mXDVseltFeg&type=embed)
