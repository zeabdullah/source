...
**connector_start** | [**\OpenAPI\Client\Model\ConnectorEndpoint**](ConnectorEndpoint.md) | The starting point of the connector. |
**connector_end** | [**\OpenAPI\Client\Model\ConnectorEndpoint**](ConnectorEndpoint.md) | The ending point of the connector. |
...
**connector_line_type** | [**\OpenAPI\Client\Model\ConnectorLineType**](ConnectorLineType.md) | Connector line type. |
**text_background** | [**\OpenAPI\Client\Model\ConnectorTextBackground**](ConnectorTextBackground.md) | Connector text background. | [optional]
**characters** | **string** | The raw characters in the text path node. |
**arc_data** | [**\OpenAPI\Client\Model\ArcData**](ArcData.md) |  |
...
**shape_type** | [**\OpenAPI\Client\Model\ShapeType**](ShapeType.md) | Geometric shape type. Most shape types have the same name as their tooltip but there are a few exceptions. ENG_DATABASE: Cylinder, ENG_QUEUE: Horizontal cylinder, ENG_FILE: File, ENG_FOLDER: Folder. |
**author_visible** | **bool** | If true, author name is visible. | [optional] [default to false]
