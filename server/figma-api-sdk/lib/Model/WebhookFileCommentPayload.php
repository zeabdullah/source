...
/**
 * WebhookFileCommentPayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookFileCommentPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookFileCommentPayload';
    ...
    protected static $openAPITypes = [
        ...
        'webhook_id' => 'string',
        'event_type' => 'string',
        'comment' => '\OpenAPI\Client\Model\CommentFragment[]',
        'comment_id' => 'string',
        'created_at' => '\DateTime',
        'file_key' => 'string',
        'file_name' => 'string',
        'mentions' => '\OpenAPI\Client\Model\User[]',
    ...
    public const EVENT_TYPE_FILE_COMMENT = 'FILE_COMMENT';
    ...
    */
     ...
     * Gets comment
     *
     * @return \OpenAPI\Client\Model\CommentFragment[]
     */
     ...
     * Sets comment
     *
     * @param \OpenAPI\Client\Model\CommentFragment[] $comment Contents of the comment itself
     *
     * @return self
     */
     ...
     * Sets comment_id
     *
     * @param string $comment_id Unique identifier for comment
     *
     * @return self
     */
     ...
     * Sets file_key
     *
     * @param string $file_key The key of the file that was commented on
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string $file_name The name of the file that was commented on
     *
     * @return self
     */
     ...
     * Sets mentions
     *
     * @param \OpenAPI\Client\Model\User[]|null $mentions Users that were mentioned in the comment
     *
     * @return self
     */
     ...
     * Sets triggered_by
     *
     * @param \OpenAPI\Client\Model\User $triggered_by The user that made the comment and triggered this event
     *
     * @return self
     */
