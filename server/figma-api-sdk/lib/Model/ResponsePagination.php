...
/**
 * ResponsePagination Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePagination';
    ...
    */
     ...
     * Sets prev_page
     *
     * @param string|null $prev_page A URL that calls the previous page of the response.
     *
     * @return self
     */
     ...
     * Sets next_page
     *
     * @param string|null $next_page A URL that calls the next page of the response.
     *
     * @return self
     */
