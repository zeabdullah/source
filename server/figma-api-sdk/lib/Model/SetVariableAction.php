...
/**
 * SetVariableAction Class Doc Comment
 *
 * @category Class
 ...
 */
class SetVariableAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetVariableAction';
    ...
    */
    ...
    public function setVariableId($variable_id)
    {
        if (is_null($variable_id)) {
            array_push($this->openAPINullablesSetToNull, 'variable_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('variable_id', $nullablesSetToNull);
            if ($index !== FALSE) {
