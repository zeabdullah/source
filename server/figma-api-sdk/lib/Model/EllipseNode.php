 ...
 */
class EllipseNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EllipseNode';
    ...
    public const TYPE_ELLIPSE = 'ELLIPSE';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of this node, represented by the string literal \"ELLIPSE\"
     *
     * @return self
     */
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling EllipseNode., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling EllipseNode., must be bigger than or equal to 0.');
        }
    ...
    public function setRelativeTransform($relative_transform)
    {
        ...
        if ((count($relative_transform) > 2)) {
            throw new \InvalidArgumentException('invalid value for $relative_transform when calling EllipseNode., number of items must be less than or equal to 2.');
        }
        if ((count($relative_transform) < 2)) {
            throw new \InvalidArgumentException('invalid length for $relative_transform when calling EllipseNode., number of items must be greater than or equal to 2.');
        }
