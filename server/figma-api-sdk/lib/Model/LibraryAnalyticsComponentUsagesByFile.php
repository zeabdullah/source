...
/**
 * LibraryAnalyticsComponentUsagesByFile Class Doc Comment
 *
 * @category Class
 ...
 */
class LibraryAnalyticsComponentUsagesByFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LibraryAnalyticsComponentUsagesByFile';
    ...
    */
     ...
     * Sets file_name
     *
     * @param string $file_name The name of the file using the library.
     *
     * @return self
     */
     ...
     * Sets team_name
     *
     * @param string $team_name The name of the team the file belongs to.
     *
     * @return self
     */
     ...
     * Sets workspace_name
     *
     * @param string|null $workspace_name The name of the workspace that the file belongs to.
     *
     * @return self
     */
     ...
     * Sets usages
     *
     * @param float $usages The number of component instances from the library used within the file.
     *
     * @return self
     */
