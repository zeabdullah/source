...
/**
 * VariableModeCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableModeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableModeCreate';
    ...
    */
     ...
     * Sets action
     *
     * @param string $action The action to perform for the variable mode.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id A temporary id for this variable mode.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of this variable mode.
     *
     * @return self
     */
     ...
     *
     * @param string $variable_collection_id The variable collection that will contain the mode. You can use the temporary id of a variable collection.
     *
     * @return self
     */
