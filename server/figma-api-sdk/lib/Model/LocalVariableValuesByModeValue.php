...
/**
 * LocalVariableValuesByModeValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocalVariableValuesByModeValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LocalVariable_valuesByMode_value';
    ...
    */
    ...
    public function setR($r)
    {
        ...
        if (($r > 1)) {
            throw new \InvalidArgumentException('invalid value for $r when calling LocalVariableValuesByModeValue., must be smaller than or equal to 1.');
        }
        if (($r < 0)) {
            throw new \InvalidArgumentException('invalid value for $r when calling LocalVariableValuesByModeValue., must be bigger than or equal to 0.');
        }
    ...
    public function setG($g)
    {
        ...
        if (($g > 1)) {
            throw new \InvalidArgumentException('invalid value for $g when calling LocalVariableValuesByModeValue., must be smaller than or equal to 1.');
        }
        if (($g < 0)) {
            throw new \InvalidArgumentException('invalid value for $g when calling LocalVariableValuesByModeValue., must be bigger than or equal to 0.');
        }
    ...
    public function setB($b)
    {
        ...
        if (($b > 1)) {
            throw new \InvalidArgumentException('invalid value for $b when calling LocalVariableValuesByModeValue., must be smaller than or equal to 1.');
        }
        if (($b < 0)) {
            throw new \InvalidArgumentException('invalid value for $b when calling LocalVariableValuesByModeValue., must be bigger than or equal to 0.');
        }
    ...
    public function setA($a)
    {
        ...
        if (($a > 1)) {
            throw new \InvalidArgumentException('invalid value for $a when calling LocalVariableValuesByModeValue., must be smaller than or equal to 1.');
        }
        if (($a < 0)) {
            throw new \InvalidArgumentException('invalid value for $a when calling LocalVariableValuesByModeValue., must be bigger than or equal to 0.');
        }
