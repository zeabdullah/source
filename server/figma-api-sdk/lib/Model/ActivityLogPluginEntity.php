...
/**
 * ActivityLogPluginEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class ActivityLogPluginEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivityLogPluginEntity';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the plugin.
     *
     * @return self
     */
     ...
     * Sets editor_type
     *
     * @param string $editor_type Indicates if the object is a plugin is available on Figma Design or FigJam.
     *
     * @return self
     */
