...
/**
 * BaseBlurEffect Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseBlurEffect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseBlurEffect';
    ...
    */
    ...
    public function setRadius($radius)
    {
        ...
        if (($radius < 0)) {
            throw new \InvalidArgumentException('invalid value for $radius when calling BaseBlurEffect., must be bigger than or equal to 0.');
        }
