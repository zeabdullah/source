...
/**
 * VariableChange Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VariableChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableChange';
    ...
    */
     ...
     * Sets action
     *
     * @param string $action The action to perform for the variable.
     *
     * @return self
     */
     ...
     *
     * @param string $variable_collection_id The variable collection that will contain the variable. You can use the temporary id of a variable collection.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of this variable.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $hidden_from_publishing Whether this variable is hidden when publishing the current file as a library.
     *
     * @return self
     */
     ...
     * Gets scopes
     *
     * @return \OpenAPI\Client\Model\VariableScope[]|null
     */
     ...
     * Sets scopes
     *
     * @param \OpenAPI\Client\Model\VariableScope[]|null $scopes An array of scopes in the UI where this variable is shown. Setting this property will show/hide this variable in the variable picker UI for different fields.
     *
     * @return self
     */
     ...
     * Gets code_syntax
     *
     * @return \OpenAPI\Client\Model\VariableCodeSyntax|null
     */
     ...
     * Sets code_syntax
     *
     * @param \OpenAPI\Client\Model\VariableCodeSyntax|null $code_syntax code_syntax
     *
     * @return self
     */
