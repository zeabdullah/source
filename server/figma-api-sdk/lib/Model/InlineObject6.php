...
class InlineObject6 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'files' => '\OpenAPI\Client\Model\InlineObject6FilesInner[]'
    ];
    ...
    */
     ...
     * Gets files
     *
     * @return \OpenAPI\Client\Model\InlineObject6FilesInner[]
     */
     ...
     * Sets files
     *
     * @param \OpenAPI\Client\Model\InlineObject6FilesInner[] $files An array of files.
     *
     * @return self
     */
