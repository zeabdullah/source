...
/**
 * BaseShadowEffect Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseShadowEffect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseShadowEffect';
    ...
    */
    ...
    public function setRadius($radius)
    {
        ...
        if (($radius < 0)) {
            throw new \InvalidArgumentException('invalid value for $radius when calling BaseShadowEffect., must be bigger than or equal to 0.');
        }
