...
/**
 * WebhookV2RequestInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookV2RequestInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookV2RequestInfo';
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string $endpoint The actual endpoint the request was sent to
     *
     * @return self
     */
     ...
     * Sets payload
     *
     * @param object $payload The contents of the request that was sent to the endpoint
     *
     * @return self
     */
     ...
     * Sets sent_at
     *
     * @param \DateTime $sent_at UTC ISO 8601 timestamp of when the request was sent
     *
     * @return self
     */
