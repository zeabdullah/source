 ...
 */
class ActivityLogAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivityLog_action';
    ...
    */
     ...
     * Sets details
     *
     * @param array<string,mixed> $details Metadata of the action. Each action type supports its own metadata attributes.
     *
     * @return self
     */
