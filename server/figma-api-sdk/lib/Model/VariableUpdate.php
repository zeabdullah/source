...
/**
 * VariableUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The id of the variable to update.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of this variable.
     *
     * @return self
     */
