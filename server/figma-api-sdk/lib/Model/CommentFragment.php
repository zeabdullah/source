...
/**
 * CommentFragment Class Doc Comment
 *
 * @category Class
 ...
 */
class CommentFragment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommentFragment';
    ...
    */
     ...
     * Sets text
     *
     * @param string|null $text Comment text that is set if a fragment is text based
     *
     * @return self
     */
     ...
     * Sets mention
     *
     * @param string|null $mention User id that is set if a fragment refers to a user mention
     *
     * @return self
     */
