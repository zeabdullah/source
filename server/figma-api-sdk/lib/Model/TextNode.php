 ...
 */
class TextNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TextNode';
    ...
    protected static $openAPITypes = [
        ...
        'characters' => 'string',
        'style' => '\OpenAPI\Client\Model\TypeStyle',
        'character_style_overrides' => 'float[]',
        'layout_version' => 'float',
        'style_override_table' => 'array<string,\OpenAPI\Client\Model\TypeStyle>',
        'line_types' => 'string[]',
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of this node, represented by the string literal \"TEXT\"
     *
     * @return self
     */
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling TextNode., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling TextNode., must be bigger than or equal to 0.');
        }
    ...
    public function setRelativeTransform($relative_transform)
    {
        ...
        if ((count($relative_transform) > 2)) {
            throw new \InvalidArgumentException('invalid value for $relative_transform when calling TextNode., number of items must be less than or equal to 2.');
        }
        if ((count($relative_transform) < 2)) {
            throw new \InvalidArgumentException('invalid length for $relative_transform when calling TextNode., number of items must be greater than or equal to 2.');
        }
     ...
     * Sets characters
     *
     * @param string $characters The raw characters in the text node.
     *
     * @return self
     */
     ...
     * Gets style
     *
     * @return \OpenAPI\Client\Model\TypeStyle
     */
     ...
     * Sets style
     *
     * @param \OpenAPI\Client\Model\TypeStyle $style Style of text including font family and weight.
     *
     * @return self
     */
     ...
     *
     * @return array<string,\OpenAPI\Client\Model\TypeStyle>
     */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\TypeStyle> $style_override_table Map from ID to TypeStyle for looking up style overrides.
     *
     * @return self
     */
