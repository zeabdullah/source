...
/**
 * WebhookV2ResponseInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookV2ResponseInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookV2ResponseInfo';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status HTTP status code of the response
     *
     * @return self
     */
     ...
     * Sets received_at
     *
     * @param \DateTime $received_at UTC ISO 8601 timestamp of when the response was received
     *
     * @return self
     */
