...
/**
 * WebhookFileVersionUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookFileVersionUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookFileVersionUpdatePayload';
    ...
    public const EVENT_TYPE_FILE_VERSION_UPDATE = 'FILE_VERSION_UPDATE';
    ...
    {
        return [
            self::EVENT_TYPE_FILE_VERSION_UPDATE,
        ];
    }
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at UTC ISO 8601 timestamp of when the version was created
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the version in the version history
     *
     * @return self
     */
     ...
     * Sets triggered_by
     *
     * @param \OpenAPI\Client\Model\User $triggered_by The user that created the named version and triggered this event
     *
     * @return self
     */
     ...
     * Sets version_id
     *
     * @param string $version_id ID of the published version
     *
     * @return self
     */
