 ...
 */
class VectorNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VectorNode';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of this node, represented by the string literal \"VECTOR\"
     *
     * @return self
     */
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling VectorNode., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling VectorNode., must be bigger than or equal to 0.');
        }
    ...
    public function setRelativeTransform($relative_transform)
    {
        ...
        if ((count($relative_transform) > 2)) {
            throw new \InvalidArgumentException('invalid value for $relative_transform when calling VectorNode., number of items must be less than or equal to 2.');
        }
        if ((count($relative_transform) < 2)) {
            throw new \InvalidArgumentException('invalid length for $relative_transform when calling VectorNode., number of items must be greater than or equal to 2.');
        }
    ...
    public function setRectangleCornerRadii($rectangle_corner_radii)
    {
        ...
        if ((count($rectangle_corner_radii) > 4)) {
            throw new \InvalidArgumentException('invalid value for $rectangle_corner_radii when calling VectorNode., number of items must be less than or equal to 4.');
        }
        if ((count($rectangle_corner_radii) < 4)) {
            throw new \InvalidArgumentException('invalid length for $rectangle_corner_radii when calling VectorNode., number of items must be greater than or equal to 4.');
        }
