...
/**
 * PostWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postWebhook_request';
    ...
    */
     ...
     * Sets team_id
     *
     * @param string|null $team_id Team id to receive updates about. This is deprecated, use 'context' and 'context_id' instead.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets context
     *
     * @param string $context Context to create the webhook for. Must be \"team\", \"project\", or \"file\".
     *
     * @return self
     */
     ...
     * Sets context_id
     *
     * @param string $context_id The id of the context you want to receive updates about.
     *
     * @return self
     */
