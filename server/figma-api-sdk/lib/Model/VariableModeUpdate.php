...
/**
 * VariableModeUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableModeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableModeUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The id of the variable mode to update.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of this variable mode.
     *
     * @return self
     */
     ...
     *
     * @param string $variable_collection_id The variable collection that contains the mode.
     *
     * @return self
     */
