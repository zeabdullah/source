...
class InlineObject11 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['img_url'] === null) {
            $invalidProperties[] = "'img_url' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Unique stable id of the user.
     *
     * @return self
     */
     ...
     * Sets handle
     *
     * @param string $handle Name of the user.
     *
     * @return self
     */
     ...
     * Sets img_url
     *
     * @param string $img_url URL link to the user's profile image.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string $email Email associated with the user's account. This property is only present on the /v1/me endpoint.
     *
     * @return self
     */
