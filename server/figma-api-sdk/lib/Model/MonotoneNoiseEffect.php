...
/**
 * MonotoneNoiseEffect Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MonotoneNoiseEffect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonotoneNoiseEffect';
    ...
    public const NOISE_TYPE_MONOTONE = 'MONOTONE';
    ...
    */
     ...
     * Sets noise_type
     *
     * @param string $noise_type The string literal 'MONOTONE' representing the noise type.
     *
     * @return self
     */
