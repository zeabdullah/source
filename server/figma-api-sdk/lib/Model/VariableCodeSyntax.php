...
/**
 * VariableCodeSyntax Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableCodeSyntax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableCodeSyntax';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('i_os', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets android
     *
     * @param string|null $android android
     *
     * @return self
     */
    ...
    {
        if (is_null($i_os)) {
            throw new \InvalidArgumentException('non-nullable i_os cannot be null');
        }
