...
/**
 * VariableModeValue Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableModeValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableModeValue';
    ...
    protected static $openAPITypes = [
        'variable_id' => 'string',
        'mode_id' => 'string',
        'value' => '\OpenAPI\Client\Model\VariableValue'
    ];
    ...
    */
     ...
     * Sets variable_id
     *
     * @param string $variable_id The target variable. You can use the temporary id of a variable.
     *
     * @return self
     */
     ...
     * Sets mode_id
     *
     * @param string $mode_id Must correspond to a mode in the variable collection that contains the target variable.
     *
     * @return self
     */
     ...
     * Gets value
     *
     * @return \OpenAPI\Client\Model\VariableValue
     */
     ...
     * Sets value
     *
     * @param \OpenAPI\Client\Model\VariableValue $value value
     *
     * @return self
     */
