...
/**
 * VariableCollectionUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableCollectionUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableCollectionUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The id of the variable collection to update.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of this variable collection.
     *
     * @return self
     */
