 ...
 */
class TableNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TableNode';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of this node, represented by the string literal \"TABLE\"
     *
     * @return self
     */
    ...
    public function setRelativeTransform($relative_transform)
    {
        ...
        if ((count($relative_transform) > 2)) {
            throw new \InvalidArgumentException('invalid value for $relative_transform when calling TableNode., number of items must be less than or equal to 2.');
        }
        if ((count($relative_transform) < 2)) {
            throw new \InvalidArgumentException('invalid length for $relative_transform when calling TableNode., number of items must be greater than or equal to 2.');
        }
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling TableNode., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling TableNode., must be bigger than or equal to 0.');
        }
