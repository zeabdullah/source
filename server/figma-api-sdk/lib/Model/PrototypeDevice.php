...
/**
 * PrototypeDevice Class Doc Comment
 *
 * @category Class
 ...
 */
class PrototypeDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrototypeDevice';
    ...
    protected static $attributeMap = [
        'type' => 'type',
        'size' => 'size',
        'preset_identifier' => 'presetIdentifier',
        'rotation' => 'rotation'
    ];
    ...
    protected static $setters = [
        'type' => 'setType',
        'size' => 'setSize',
        'preset_identifier' => 'setPresetIdentifier',
    ...
    protected static $getters = [
        'type' => 'getType',
        'size' => 'getSize',
        'preset_identifier' => 'getPresetIdentifier',
    ...
    public const ROTATION_CCW_90 = 'CCW_90';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('preset_identifier', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets preset_identifier
     *
     * @return string|null
     */
    public function getPresetIdentifier()
    {
        return $this->container['preset_identifier'];
    }

    /**
     * Sets preset_identifier
     *
     * @param string|null $preset_identifier preset_identifier
     *
     * @return self
     */
    public function setPresetIdentifier($preset_identifier)
    {
        if (is_null($preset_identifier)) {
            throw new \InvalidArgumentException('non-nullable preset_identifier cannot be null');
        }
        $this->container['preset_identifier'] = $preset_identifier;
