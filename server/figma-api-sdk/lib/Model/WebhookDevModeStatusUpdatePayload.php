...
/**
 * WebhookDevModeStatusUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookDevModeStatusUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookDevModeStatusUpdatePayload';
    ...
    protected static $openAPITypes = [
        ...
        'file_name' => 'string',
        'node_id' => 'string',
        'related_links' => '\OpenAPI\Client\Model\DevResource[]',
        'status' => 'string',
    ...
    public const EVENT_TYPE_DEV_MODE_STATUS_UPDATE = 'DEV_MODE_STATUS_UPDATE';
    ...
    {
        return [
            self::EVENT_TYPE_DEV_MODE_STATUS_UPDATE,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('related_links', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['related_links'] === null) {
            $invalidProperties[] = "'related_links' can't be null";
        }
     ...
     * Sets file_key
     *
     * @param string $file_key The key of the file that was updated
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string $file_name The name of the file that was updated
     *
     * @return self
     */
     ...
     * Sets node_id
     *
     * @param string $node_id The id of the node where the Dev Mode status changed. For example, \"43:2\"
     *
     * @return self
     */
    ...
    {
        return $this->container['related_links'];
    }

    /**
     * Sets related_links
     *
     * @param \OpenAPI\Client\Model\DevResource[] $related_links An array of related links that have been applied to the layer in the file
     *
     * @return self
     */
    public function setRelatedLinks($related_links)
    {
        if (is_null($related_links)) {
            throw new \InvalidArgumentException('non-nullable related_links cannot be null');
        }
        $this->container['related_links'] = $related_links;
     ...
     * Sets status
     *
     * @param string $status The Dev Mode status. Either \"NONE\", \"READY_FOR_DEV\", or \"COMPLETED\"
     *
     * @return self
     */
     ...
     * Sets triggered_by
     *
     * @param \OpenAPI\Client\Model\User $triggered_by The user that made the status change and triggered the event
     *
     * @return self
     */
