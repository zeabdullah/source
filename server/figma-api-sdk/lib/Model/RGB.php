...
class RGB implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setR($r)
    {
        ...
        if (($r > 1)) {
            throw new \InvalidArgumentException('invalid value for $r when calling RGB., must be smaller than or equal to 1.');
        }
        if (($r < 0)) {
            throw new \InvalidArgumentException('invalid value for $r when calling RGB., must be bigger than or equal to 0.');
        }
    ...
    public function setG($g)
    {
        ...
        if (($g > 1)) {
            throw new \InvalidArgumentException('invalid value for $g when calling RGB., must be smaller than or equal to 1.');
        }
        if (($g < 0)) {
            throw new \InvalidArgumentException('invalid value for $g when calling RGB., must be bigger than or equal to 0.');
        }
    ...
    public function setB($b)
    {
        ...
        if (($b > 1)) {
            throw new \InvalidArgumentException('invalid value for $b when calling RGB., must be smaller than or equal to 1.');
        }
        if (($b < 0)) {
            throw new \InvalidArgumentException('invalid value for $b when calling RGB., must be bigger than or equal to 0.');
        }
