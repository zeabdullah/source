...
class InlineObject36 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'rows' => '\OpenAPI\Client\Model\InlineObject36Rows',
        'next_page' => 'bool',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets rows
     *
     * @return \OpenAPI\Client\Model\InlineObject36Rows
     */
     ...
     * Sets rows
     *
     * @param \OpenAPI\Client\Model\InlineObject36Rows $rows rows
     *
     * @return self
     */
     ...
     * Sets next_page
     *
     * @param bool $next_page Whether there is a next page of data that can be fetched.
     *
     * @return self
     */
     ...
     * Sets cursor
     *
     * @param string|null $cursor The cursor to use to fetch the next page of data. Not present if next_page is false.
     *
     * @return self
     */
